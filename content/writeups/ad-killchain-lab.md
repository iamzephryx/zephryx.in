...
**[KillChainSigma](https://github.com/iamzephryx/KillChainSigma)** — instead
...
[`kerberoasting.yml`](https://github.com/iamzephryx/KillChainSigma/blob/main/rules/1-credential-access/kerberoasting.yml).
...
[`asrep-roasting.yml`](https://github.com/iamzephryx/KillChainSigma/blob/main/rules/1-credential-access/asrep-roasting.yml),
looks for.
...
[`pass-the-hash.yml`](https://github.com/iamzephryx/KillChainSigma/blob/main/rules/2-lateral-movement/pass-the-hash.yml),
...
into `ADMIN$` — rule 4,
[`remote-service-creation.yml`](https://github.com/iamzephryx/KillChainSigma/blob/main/rules/2-lateral-movement/remote-service-creation.yml).
...
[`wmi-execution.yml`](https://github.com/iamzephryx/KillChainSigma/blob/main/rules/2-lateral-movement/wmi-execution.yml).
...
[`dcsync.yml`](https://github.com/iamzephryx/KillChainSigma/blob/main/rules/3-domain-dominance/dcsync.yml)
...
[`golden-ticket.yml`](https://github.com/iamzephryx/KillChainSigma/blob/main/rules/3-domain-dominance/golden-ticket.yml),
...
each rule, is here: **[KillChainSigma](https://github.com/iamzephryx/KillChainSigma)**.
