  ...
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
      ...
      <div
        ...
        style={{ opacity: 'var(--backdrop-grid-opacity)' }}
      />
      ...
      />
      <div
        className="animate-drift absolute -bottom-1/3 -left-1/4 h-[60vh] w-[60vw] rounded-full blur-[130px]"
        style={{
          animationDelay: '-11s',
          opacity: 'var(--backdrop-bloom-2-opacity)',
          background:
      ...
      {/* vignette — colors swap with the theme via CSS custom properties */}
      <div
      ...
      <div
        ...
        style={{
          ...
          mixBlendMode: 'var(--backdrop-grain-blend)' as React.CSSProperties['mixBlendMode'],
        }}
      />
    </div>
  );
